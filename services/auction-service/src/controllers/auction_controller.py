...
async def create_auction(
    ...
    return await auction_service.create(data, user_id)
...
async def update_auction(
    ...
    return await auction_service.update(auction_id, data, user_id)
...
async def delete_auction(
    ...
    await auction_service.delete(auction_id, user_id)
...
async def open_auction(
    ...
    return await auction_service.open(auction_id, user_id)
...
async def close_auction(
    ...
    return await auction_service.close(auction_id, user_id)
