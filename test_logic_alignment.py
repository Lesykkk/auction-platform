...
async def run_test_logic():
    async with httpx.AsyncClient(timeout=10.0, follow_redirects=True) as client:
        ...
        auction_resp = await client.post(
            ...
            json={
                "title": "Logic Test Auction",
                "description": "Verification of real-time refunds",
        ...
        lot_resp = await client.post(
            ...
            json={
                ...
                "title": "Test Lot",
                "description": "Testing price update and refund",
        ...
        # 6. TEST 2: Charlie bids $200
        print("6. TEST 2: Charlie bids $200 (Bob should be refunded immediately)...")
        bid_resp = await client.post(
            f"{BIDDING_API}/bids",
        ...
        bob_info = (await client.get(f"{USER_API}/users/me", headers={"Authorization": f"Bearer {tokens['bob']}"})).json()
        print(f"Bob Locked Balance: {bob_info['locked_balance']} (Expected: 0.00)")
        ...
        # 7. Close Auction
        print("7. Closing Auction & Settlement...")
        ...
        print(f"Alice Final Balance: {alice_final['balance']} (Expected: 1200.00)") 
        ...
        print(f"Charlie Final Balance: {charlie_final['balance']} (Expected: 800.00)")
